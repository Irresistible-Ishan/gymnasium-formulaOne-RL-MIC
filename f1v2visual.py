...
class FastTrackEnv(gym.Env):
    ...
    def step(self, action):
        ...
        # Added a tiny breadcrumb reward so it learns to move forward
    ...
    def render(self):
        ...
        # Scaling factor to fit the 100m track in a 600px window
        SCALE = 6
        CENTER = (300, 300)
        ...
        pygame.event.pump()
        pygame.display.flip()
        self.clock.tick(30) # Lock to 30 FPS for visual testing
...
# ==========================================
# 2. RUNNING THE TRAINING & VISUALIZATION
# ==========================================
if __name__ == "__main__":
    ...
    for _ in range(1000):
        ...
        test_env.render() # Draw the frame!
        ...
        if terminated or truncated:
            ...
            # Keep the window open for a second so you see the crash
